#!/usr/bin/env python3
"""
Test crime AI assistant with properly cited responses
"""
...
def main():
    """Test with 3 standard addresses and one question"""
    ...
    print("=" * 80)
    print("CRIME AI ASSISTANT - CITATION AND FORMAT TEST")
    print("=" * 80)
    print(f"\nQuestion: {question}")
    ...
    print("  ✓ Radius specification (0.5 miles)")
    print("  ✓ Supporting statistics (bulleted)")
    print("  ✓ Trend information")
    print("  ✓ Data source with crime map link")
    print("  ✓ Disclaimers about reported crimes")
    print("  ✓ Current date")
